package io.mobinity.wantact.aop_part4_chapter06.appwidget
...
import io.mobinity.wantact.aop_part4_chapter06.R
import io.mobinity.wantact.aop_part4_chapter06.data.Repository
import io.mobinity.wantact.aop_part4_chapter06.data.models.airquality.Grade
    ...
    class UpdateWidgetService : LifecycleService() {
        ...
        override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
            if (
                ...
                val updateViews = RemoteViews(packageName, R.layout.widget).apply {
                    setTextViewText(
                        R.id.resultTextView,
                        "권한 없음"
                    )
