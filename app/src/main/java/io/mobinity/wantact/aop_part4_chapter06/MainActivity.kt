...
import java.lang.Exception
 ...
 class MainActivity : AppCompatActivity() {
        ...
        fusedLocationProviderClient.getCurrentLocation(
            ...
            scope.launch {
                ...
                try {
                    ...
                    displayAirQuality(monitoringStation, measuredValue!!)
    ...
    private fun displayAirQuality(monitoringStation: MonitoringStation, measuredValue: MeasuredValue) {
